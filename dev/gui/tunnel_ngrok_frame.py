...
class TunnelNgrokFrame(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        ttk.Label(
            ...
            pady=(
                ...
                5),
            padx=20)
        entry1 = ttk.Entry(self, textvariable=self.auth_token, width=50, font=("Meiryo", 11))
        ...
        radio_frame.grid(row=5, column=0, columnspan=3, sticky="w", padx=20, pady=(0, 10))

        # スタイルでフォントサイズを指定
        style = ttk.Style(self)
        style.configure("My.TRadiobutton", font=("Meiryo", 14))
    ...
    def save_settings(self):
        ...
        tk.messagebox.showinfo("保存完了", "ngrokの設定が保存されました。")
