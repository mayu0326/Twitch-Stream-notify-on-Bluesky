    ...
    def create_widgets(self) -> None:
        ...
        ttk.Label(
            ...
            pady=(
                ...
                5),
            padx=20)
        self.cmd_entry = ttk.Entry(self, textvariable=self.cmd_var, width=50, font=("Meiryo", 11))
        self.cmd_entry.grid(row=3, column=0, padx=20, pady=(0, 10), columnspan=2, sticky="ew")
        ...
        save_btn = ttk.Button(
            self,
            text="コマンド設定を保存",
            command=self.save_localtunnel_cmd,
            style="Large.TButton")
        save_btn.grid(row=4, column=0, pady=5, padx=(20, 5), sticky="w")
        ...
        self.start_btn = ttk.Button(
            ...
            style="Large.TButton")
        self.start_btn.grid(row=4, column=1, pady=5, padx=(5, 20), sticky="w")

        # ステータス表示
        self.status_label = ttk.Label(self, textvariable=self.status_var, foreground="blue")
        self.status_label.grid(row=6, column=0, pady=3, padx=20, sticky="w")
        ...
        self.url_entry = ttk.Entry(
            ...
            font=(
                "Meiryo",
                11))
        self.url_entry.grid(row=7, column=0, pady=(0, 10), padx=20, sticky="ew", columnspan=2)
    ...
    def save_localtunnel_cmd(self) -> None:
        ...
        try:
            ...
            with open(SETTINGS_ENV_FILE, "w", encoding="utf-8") as f:
                f.writelines(lines)
            messagebox.showinfo("保存完了", "LocalTunnelコマンドとポート設定を保存しました。")
